...
<TopBarFooter >
      ...
      <TopBar >
        ...
        <FooterDiv>
               <div className="centro">
                <p style={{textAlign:'center'}}>&copy; {anoCopy} Copyright - {process.env.NEXT_PUBLIC_SITE_NAME} <br/> VOLANTE REFRESCANTE UNIPESSOAL LDA PT517517620  Rua 25 de Abril, 42B - 2620-041 Odivelas</p>
